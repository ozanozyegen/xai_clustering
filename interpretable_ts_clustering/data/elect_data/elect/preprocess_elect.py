...
def prep_data(data, covariates, data_start, train = True):
    ...
    print("windows pre: ", windows_per_series)

    # only take data where first nonzero value occurs
...
if __name__ == '__main__':
    ...
    train_timestamps = data_frame[train_start:train_end].index
    test_timestamps = data_frame[test_start:test_end].index

    np.save("data/elect/train_timestamps",train_timestamps)
    np.save("data/elect/test_timestamps", test_timestamps)
